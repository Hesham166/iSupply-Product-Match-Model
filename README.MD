...
This function creates `validation_output.xlsx` file that contains the top `k` similar candidates with their `sku` and similarity score, `sim`. The function returns pandas DataFrame.
